...
<%
	String result = (String) request.getAttribute("boardlist");
%>
</head>
<body>
	<div id="header">
		<section class="header">
			...
			<ul class="header_menu">
				...
				<li><a href="2Join.html.html"><%=result %></a></li>
	...
	<%if(!result.isEmpty()){ %>
		...
		<table>
			<tr>
				<th width="130">공지</th>
				<th width="659">공지입니다.</th>
				<th>LOGO</th>
				<th width="180">1212.12.12</th>
				<th width="188">100</th>
			</tr>
		</table>
	<% } %>
		...
		<table>
			<tr>
				<td width="130">1</td>
				<td width="659">자유게시판 입니다.</td>
				<td>슈퍼 그랑-조</td>
				<td width="180">1212.12.15</td>
				<td width="188">50</td>
			</tr>
		</table>
