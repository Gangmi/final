...
<body>
    <form action="find_id_act.do" id="findId" method="post" target="result">
        <table>
            ...
            <tr>
               ...
               <td>
               	   <a href="/login.do"><button type="button"> 로그인 하기</button></a>
               </td>
            </tr>
        </table>
    </form>
    ...
    $(document).ready(function(){
        $("#btnFind").click(function (e){
        	...
        	window.open("", "result", "height=500, width=700, menubar=no, scrollbars=yes, resizable=no, toolbar=no, status=no, left=50, top=50");
            $('#findId').submit();
        });
