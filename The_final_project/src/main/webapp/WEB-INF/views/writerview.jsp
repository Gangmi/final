	...
	<section id="allboards">
		<div class="container upboards">
			...
			<div class="freeboard">
				...
				<table class="table table-hover table-condensed">
					...
					%>
						<tr>
							...
							<td class="titles"><a
								href="writerview.do?b_boardname=free_board&boardno=<%=vo.getBoardno()%>&nickname=<%=vo.getNickname()%>"><%=vo.getTitle()%></a></td>
				...
				<div id="more">
					<a href="/mywriteview.do?b_boardname=free_board">더보기+</a>
				</div>
			...
			<div class="tipboard">
				...
				<table class="table table-hover table-condensed">
					...
					%>
						<tr>
							...
							<td class="titles"><a
								href="writerview.do?b_boardname=tip_board&boardno=<%=vo.getBoardno()%>&nickname=<%=vo.getNickname()%>"><%=vo.getTitle()%></a></td>
				...
				<div id="more">
					<a href="/mywriteview.do?b_boardname=tip_board">더보기+</a>
				</div>
		...
		<div class="container downboards">
			...
			<div class="freeboard">
				...
				<table class="table table-hover table-condensed">
					...
					%>
						<tr>
							...
							<td class="titles"><a
								href="writerview.do?b_boardname=nongsain&boardno=<%=vo.getBoardno()%>&nickname=<%=vo.getNickname()%>"><%=vo.getTitle()%></a></td>
				...
				<div id="more">
					<a href="/mywriteview.do?b_boardname=nongsain">더보기+</a>
				</div>
			...
			<div class="tipboard">
				...
				<table class="table table-hover table-condensed">
					...
					%>
						<tr>
							...
							<td class="titles"><a
								href="writerview.do?b_boardname=parcel_board&boardno=<%=vo.getBoardno()%>&nickname=<%=vo.getNickname()%>"><%=vo.getTitle()%></a></td>
				...
				<div id="more">
					<a href="/mywriteview.do?b_boardname=parcel_board">더보기+</a>
				</div>
			</div>
		</div>
	</section>
